                ...
                <div className="max-w-md mx-auto">
                    ...
                    <div className="divide-y divide-gray-200">
                        <form onSubmit={handleLogin} className="py-8 text-base leading-6 space-y-4 text-gray-700 sm:text-lg sm:leading-7">
                            ...
                            <p>If you don't have an account, Please <Link to="/sign-up" className='text-blue-600'>SignUp</Link> here</p>
                            <div className="relative">
                    ...
                    <div className='flex w-full items-center flex-col mt-5 gap-3'>
                        <button onClick={handleRegister} className='block'> <img src="https://www.vectorlogo.zone/logos/google/google-icon.svg" alt="" className='w-12 h-12 inline-block' /> Login with Google</button>
                    </div>
                </div>
            </div>
        </div>
